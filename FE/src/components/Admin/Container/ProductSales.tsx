...
export default () => {
  ...
  const check_doanh_so = () => {
    if (showModel == "Tất cả")
      return quantity_all
    if (showModel == "Đồ ăn nhanh")
      return quantity_shirt
    if (showModel == "Món ăn")
      return quantity_shoes
    if (showModel == "Đồ uống")
  ...
  return (
    <div className="container">
      ...
      <button className="bttn" style={{marginLeft: 10, marginRight: 10, marginBottom: 10, backgroundColor: checkColor("Đồ ăn nhanh") }} onClick={() => setShowModel("Đồ ăn nhanh")}>Đồ ăn nhanh</button>
      <button className="bttn" style={{marginLeft: 10, marginRight: 10, marginBottom: 10, backgroundColor: checkColor("Món ăn") }} onClick={() => setShowModel("Món ăn")}>Món ăn</button>
      <button className="bttn" style={{marginLeft: 10, marginRight: 10, marginBottom: 10, backgroundColor: checkColor("Đồ uống") }} onClick={() => setShowModel("Đồ uống")}>Đồ uống</button>
