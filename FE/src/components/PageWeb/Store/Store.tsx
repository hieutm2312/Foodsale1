        ...
        <div className="bodyContainer">
          ...
          <section className="about">
            ...
            <div className="flex">
              ...
              <div className="image">
                <img src="Frontend_websales/src/images/Delivery Service Illustration.jpg" alt="" />
              </div>
            ...
            <div className="flex">
              ...
              <div className="content">
                ...
                <p>Cùng xem những đánh giá từ những khách hàng đã mua sản phẩm từ Foodsales.</p>
