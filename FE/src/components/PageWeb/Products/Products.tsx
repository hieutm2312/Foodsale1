          ...
          <div className="btn-filter">
            ...
            <div id="headerSection">
              <ul className="headerList">
                ...
                <li className="headerItem">
                  <button className="link bttn" onClick={() => getAPI("http://localhost:9191/productByModel/Đồ ăn nhanh")}>
                    Đồ ăn nhanh
                  </button>
                </li>
                <li className="headerItem">
                  <button className="link bttn" onClick={() => getAPI("http://localhost:9191/productByModel/Món ăn")}>
                    Món ăn
                  </button>
                </li>
                <li className="headerItem">
                  <button className="link bttn" onClick={() => getAPI("http://localhost:9191/productByModel/Đồ uống")}>
                    Đồ uống
                  </button>
                </li>
              </ul>
                ...
                modalColor ?
                  <div id="modalColor">
                    ...
                    <div className="buttonContainer">
                      {
                        ["All", "red", "green", "black", "pink", "brown", "orange", "white", "gray", "purple", "yellow"]
                          .map((value) => (
